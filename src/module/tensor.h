...
class Tensor : public std::enable_shared_from_this<Tensor> {
 public:
  ...
  // When false, this tensor is excluded from Module::get_size() cache accounting.
  // Used by representative cache tensors whose footprint is tracked analytically
  // via Module::logical_cache_bytes_ instead.
  bool count_in_footprint = true;

  void setCountInFootprint(bool v) { count_in_footprint = v; }
  bool countsInFootprint() const { return count_in_footprint; }
