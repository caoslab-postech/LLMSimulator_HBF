...
class TimeStamp {
 public:
  ...
  void print();
  void printNoEnergy();  // Recursive print without energy fields
  void printForGantt();  // Recursive, energy-excluded format for gantt export
...
class TimeBoard {
 public:
  ...
  void printNoEnergy() { top.printNoEnergy(); }
